...
После чего станет доступна <a href="/admin/comments">страница администратора</a>, которая похожа на <a href="/comments">страницу комментариев</a>, но с элементами управления для администрирования.
